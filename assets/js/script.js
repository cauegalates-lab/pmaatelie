...
const storeProductCollections = [
  {
    id: 'mais-vendidos',
    title: 'Mais vendidos',
    subtitle: 'Produtos com maior procura para datas especiais, presentes afetivos e lembranças rápidas.',
  ...
  },
  {
    ...
    subtitle: 'Itens clássicos para colocar foto, nome, frase, data ou mensagem especial.',
  ...
  },
  {
    ...
    subtitle: 'Combinações prontas para surpreender com acabamento bonito e sensação de presente completo.',
  ...
  },
  {
    ...
    subtitle: 'Sugestões para empresas, eventos, lembranças e pedidos sob encomenda.',
...
function renderStoreProducts() {
  ...
  storeQueryAll('[data-store-add-to-cart]', showcase).forEach((button) => {
    button.addEventListener('click', () => addStoreProductToCart(button.dataset.storeAddToCart));
  });
